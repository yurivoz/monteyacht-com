...
about_p2:'We are not a cruise operator — we know these waters personally: every hidden cove of Boka Bay, the best swimming spots, and the exact moment when the golden light settles over the bay. Our experienced captain knows how to make every journey calm, private, and exactly the way you imagined it. Each route is planned individually the day before departure, taking into account your preferences, pace, and weather conditions at sea. Marea comfortably accommodates up to 16 guests for day charters and up to 6 guests for overnight stays in the cabins.',
...
blog_art2_quote:'"I\'ve crossed this bay for seven years. Thousands of sunsets. And I still cut the engine every time and watch. Guests do the same — they drink champagne and stay quiet for twenty minutes. It\'s the quietest part of the charter." — Captain Alexey',
blog_art2_s1_title:'Why this exact hour',
blog_art2_s1_desc:'Technically — the sun drops behind the Orjen mountains, on the western side of the bay. The mountains are about 1,900 metres high, so the sun hides behind them earlier than it would at the sea horizon. That gives you a double golden light: the sun still hits the eastern mountains, which reflect into the water, while the western side is already in shadow. In <a href="blog-june-vs-september.html">June and early July</a> this works between 19:30 and 20:30. In August it shifts to 19:00–20:00. In September — 18:30–19:30. In October sunset is around 17:30 and the light has more red, less gold. In May and October the light is different — low sun, long shadows, but the "warm amber" doesn\'t happen every day. It depends on clouds. The best days are after light rain, when the air is clear.',
...
blog_art3_s2_desc:'In the morning, in Tivat — the fish market. Sea bream and sea bass from the same fisherman who has given us his morning catch for seven years. Prawns from there too. Vegetables — at the market next door, from a woman who knows our steward by name. <a href="blog-oysters-prawns.html">In Kamenari on the way — oysters</a>. We order them from the yacht, they arrive on a small boat in about twenty minutes. That\'s a separate gastro moment, not lunch: the oysters get opened on deck, we eat them with lemon and a drop of tabasco. Everything is local, same-day. Nothing imported, nothing thawed.',
...
blog_art8_quote:'"In seven seasons I can\'t pick a favourite month. In June the bay smells different — those are wildflowers on the mountains. In September the light is different — the sun is lower. They\'re just two different summers." — Captain Alexey',
...
blog_art8_s3_desc:'June: tourists are there, but Kotor isn\'t packed. On the Perast waterfront you can sit down at a restaurant without a booking. At the <a href="blog-blue-cave.html">Blue Cave</a> at noon — 3 to 5 boats at once, a 10-minute wait. September: similar to June, but by the 20th it\'s almost empty. Cruise ships come to Kotor with older tourists (not families), evenings are quieter. July-August: peak. The cave queue is 20-30 minutes, Kotor is crowded, restaurants need bookings. Anchorages full by 10am.',
...
blog_art8_s6_desc:'June: the sun sets at 20:30. Long evenings, <a href="blog-sunset-champagne.html">golden hour</a> 19:00-20:00. September: sunset is 18:30 (start) — 17:45 (end). Days are shorter, but the light in the sunset is more "gold" — because the sun is lower. For a 12-hour charter with a sunset — both months work. But in June the sunset is later, you can have dinner on deck after returning. In September it gets dark faster after sunset.',
...
blog_art9_s3_desc:'Miloš is a fisherman from Prčanj, with a spot at the dock halfway to Kotor. Not a shop, not a restaurant — just a pier where he sorts his morning catch. We then <a href="blog-bbq-anchor.html">grill the prawns at anchor in the same cove</a>. We pull in here on the way to Kotor — it\'s the midpoint. Tender to the pier, pick from what\'s there. What\'s usually available: tiger prawns — €25-35 per kg; blue langoustines — €40-60 per kg (when in season); pink scampi — €18-25 per kg; sometimes lobster (€80+, rare). Best season: May to October. In winter Miloš isn\'t on the water. We take the prawns alive and grill them in the same cove within an hour of buying. That "from sea to plate in an hour" only works on the water.',
...
blog_art9_s5_desc:'This is a scenario we suggest for romantic dinners: 12-hour charter, last stop near Perast or Prčanj, we order a dozen oysters + a bottle of Krstač + <a href="blog-sunset-champagne.html">sunset</a>. Guests pay separately for oysters and wine (about €40-50 per couple), but the effect is a different day. Not "lunch with seafood", a scene.',
...
blog_art4_quote:'"I\'ve been coming here for seven years. I still can\'t predict which day will be brighter — it depends on clouds, the tide, and, I suspect, the mood of the sea. But the 11-to-13 window is steady." — Captain Alexey',
...
blog_art4_s3_desc:'From Porto Montenegro to the cave it\'s two hours of steady cruising. So we leave at 9:00, and at 11:00 we\'re at the entrance. Two places along the way you don\'t pass by. <a href="blog-submarine-mamula.html">The submarine docks under Luštica and Mamula island</a> — a former Yugoslav military base and a 19th-century Austro-Hungarian fortress. We spend thirty to forty minutes in the cave: we enter, cut the engine, swim, take photos.',
...
blog_art5_s5_desc:'If you want to reach Kotor — you need six hours minimum. An hour and a half there, an hour and a half back, at least an hour at Kotor itself. Four hours won\'t do it. Read about the <a href="blog-boka-bay-route.html">8-hour Bay of Kotor route</a> in a separate article. If you want the <a href="blog-blue-cave.html">Blue Cave</a> — that\'s an 8-hour route (€2,600). The light in the cave works between 11 and 13 — a short charter doesn\'t fit the window. If you want a sunset on the water — go 8 or 12 hours. The golden hour in summer is 19:30–20:30. A 4-hour charter ends back at the marina by 13:00 or 17:00, nowhere near sunset.',
...
blog_art6_quote:'"In seven years I\'ve found places even the local water taxis don\'t go. Not because they\'re secret — because they\'re not worth the trip in groups. Too quiet, nothing to show on camera." — Captain Alexey',
blog_art6_s1_title:'1. Plavi Horizont',
blog_art6_s1_desc:'On the southern side of Luštica, west of the <a href="blog-blue-cave.html">Blue Cave</a>. Plavi Horizont means "blue horizon". This isn\'t a beach — it\'s a large open bay facing the Adriatic. The water is deep right at the entrance — we anchor and swim. The seabed is white sand, water in August is 25–26 °C. No restaurants on shore, no crowds. Sometimes two or three sailing yachts at anchor, that\'s it. The convenient part: it\'s on the way back from the Blue Cave. If you have an 8-hour charter with the cave, Plavi Horizont fits naturally into the afternoon.',
...
hero_h1:'Адриатика, которую невозможно<br>почувствовать с берега',
...
about_p2:'Мы не сеть и не круизный оператор — мы лично знаем эти воды: каждую скрытую бухту Боки, лучшие места для купания и тот самый момент, когда золотой свет опускается на залив. Наш опытный капитан знает как сделать каждую прогулку спокойной, приватной и именно такой, как вы мечтали. Каждый маршрут мы составляем индивидуально за день до выхода — учитывая ваши пожелания, ритм отдыха и погодные условия. На борту с комфортом разместятся до 16 гостей для дневного путешествия и 6 гостей для отдыха с ночевкой в каютах.',
...
blog_art3_s4_desc:'Не на ходу. Мы становимся на якорь в <a href="blog-secret-anchorages.html">тихой бухте</a> — и обедаем минут сорок-час. Любимые места для якоря с обедом: бухта у Перастa — защищённая, мелкая, вид на остров Богородицы на Рифе; Жанница — рядом с Голубой пещерой, западная Луштица, хорошо для маршрута с пещерой; Моринь — у горных источников, вода чуть холоднее, но очень тихо; Дурашевичи — напротив Страдиоти, с понтоном если хотите выйти на берег после. Капитан сам предлагает место по погоде дня — где не будет ветра и где волна не помешает.',
...
blog_art7_s1_desc:'До 2 лет — берём с осторожностью. На яхте есть тенистая зона в кокпите и каюта с кроватью. Подойдёт <a href="blog-4-hours-tivat.html">4 часа</a> в спокойную погоду, не больше. Маршрут — Госпа од Шкрпела + купание в Морень. Дети 3–6 лет — 4 или 6 часов максимум. В этом возрасте устают от солнца и новизны. Лучше короткие выходы с одним длительным купанием. 7–10 лет — 6 или 8 часов. Уже выдерживают полный день. Можно включить Котор с прогулкой по стенам — детям обычно нравится. 11+ — любой чартер. Подростки на воде ведут себя как взрослые, только активнее. Скутер и SUP-доска — их любимое. С детьми младше 5 лет не берём <a href="blog-blue-cave.html">маршрут с Голубой пещерой</a> — там 8 часов, открытое море, проход у Луштицы может качать. Это не для малышей.',
...
blog_art8_quote:'«За семь сезонов я не могу выбрать любимый месяц. В июне залив пахнет иначе — это цветы на горах. В сентябре свет другой — ниже солнце. Это просто два разных лета.» — Капитан Алексей',
...
blog_art8_s3_desc:'Июнь: туристы есть, но Котор не забит. На набережной Перастa можно сесть в ресторан без брони. У <a href="blog-blue-cave.html">Голубой пещеры</a> в 12:00 — 3-5 лодок одновременно, очередь на 10 минут. Сентябрь: похоже на июнь, но к 20-м числам — почти пусто. В Котор приходят круизные лайнеры с пожилыми туристами (не семьями), вечером тише. Июль-август: пик. У пещеры очередь 20-30 минут, Котор переполнен, рестораны без брони не возьмут. Якорные стоянки забиты с 10 утра.',
...
blog_art8_s6_desc:'Июнь: солнце садится в 20:30. Длинные вечера, <a href="blog-sunset-champagne.html">золотой час</a> 19:00-20:00. Сентябрь: закат в 18:30 (начало) — 17:45 (конец). Дни короче, но свет в закате более «золотой» — потому что солнце ниже. Для 12-часового чартера с закатом — оба месяца работают. Но в июне закат позже, можно поужинать на палубе после возвращения. В сентябре после заката быстрее темнеет.',
...
blog_art9_s5_desc:'Это сценарий, который мы рекомендуем для романтических ужинов: 12-часовой чартер, последняя остановка у Перастa или Прчаня, заказываем дюжину устриц + бутылку Krstač + <a href="blog-sunset-champagne.html">закат</a>. Гости платят за устрицы и вино отдельно (около €40-50 на пару), но эффект — другой день целиком. Не «обед с морепродуктами», а сцена.',
...
blog_art4_quote:'«Я хожу сюда семь лет. До сих пор не могу предсказать, какой день будет ярче — зависит от облаков, прилива и, я подозреваю, от настроения моря. Но окно с 11 до 13 — стабильное.» — Капитан Алексей',
...
blog_art4_s3_desc:'Из Порто Монтенегро до пещеры — два часа спокойного хода. Значит выход в 9:00, в 11:00 мы у входа. По дороге — два места, мимо которых не пройти. <a href="blog-submarine-mamula.html">Доки подводных лодок под Луштицей и остров Мамула</a> — бывшая военная база Югославии и австро-венгерская крепость XIX века. В пещере проводим минут тридцать-сорок: заходим, выключаем мотор, плаваем, фотографируем.',
...
blog_art5_s5_desc:'Если хотите дойти до Котора — нужно шесть часов минимум. Туда полтора часа, обратно полтора, на сам Котор — ещё хотя бы час. В 4 часа не успеть. Подробный <a href="blog-boka-bay-route.html">8-часовой маршрут по заливу</a> — отдельная статья. Если хотите попасть в <a href="blog-blue-cave.html">Голубую пещеру</a> — это отдельный маршрут на 8 часов (€2 600). Свет в пещере ловится с 11 до 13 — короткий чартер сюда не вписывается. Если хотите закат на воде — берите 8 или 12 часов. Золотой час летом в 19:30–20:30. В 4-часовом чартере мы возвращаемся в марину к 13:00 или 17:00, не во время заката.',
...
blog_art6_quote:'«За семь лет я нашёл места, куда не идут даже местные катера-такси. Не потому что секретные — просто туда не выгодно возить группами. Слишком тихо, нечего показать на камеру.» — Капитан Алексей',
blog_art6_s1_title:'1. Плави Горизонт',
blog_art6_s1_desc:'На юге Луштицы, западнее <a href="blog-blue-cave.html">Голубой пещеры</a>. С греческого Plavi Horizont — «голубой горизонт». Это не пляж, а большая открытая бухта с видом в Адриатику. Вода глубокая прямо у входа — заходим, бросаем якорь, плаваем. Дно белое, песчаное, вода в августе 25–26 °C. Никаких прибрежных ресторанов, никаких толп. Иногда стоят две-три парусные яхты на якоре, и всё. Удобно тем, что находится по пути обратно от Голубой пещеры. Если у вас 8-часовой чартер с пещерой — Плави Горизонт логично встроить во вторую половину дня.',
...
blog_art6_s4_desc:'Рыбацкая деревня на полуострове Луштица, с маленькой марины. Здесь живут пятьдесят семей и работает один настоящий <a href="blog-bbq-anchor.html">рыбный ресторан</a> — без меню, без вывески, просто стулья на причале. Бросаем якорь в бухте, доходим до берега на тендере. Спрашиваем, что сегодня поймали. Заказываем без обсуждения — что есть, то и едим. Обычно дорадо, иногда осьминог, иногда то, чего вы не пробовали в Котор. Бигова — это обед на 1.5 часа, не быстрая остановка. Хорошо вписывается в 8-часовой маршрут «Уединённый» (Маршрут #4). Платите за столом, цены — €30–50 на человека с вином.',
