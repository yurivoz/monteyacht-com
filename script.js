...
blog_art3_s2_desc:'In the morning, in Tivat — the fish market. Sea bream and sea bass from the same fisherman who has given us his morning catch for fifteen years. Prawns from there too. Vegetables — at the market next door, from a woman who knows our steward by name. <a href="blog-oysters-prawns.html">In Kamenari on the way — oysters</a>. We order them from the yacht, they arrive on a small boat in about twenty minutes. That\'s a separate gastro moment, not lunch: the oysters get opened on deck, we eat them with lemon and a drop of tabasco. Everything is local, same-day. Nothing imported, nothing thawed.',
