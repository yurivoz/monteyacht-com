...
events_page_sub:'A small season of curated evenings on the Adriatic — sunset gatherings, season openings, one-night voyages. By reservation, twelve guests at a time.',
events_why_eyebrow:'The format',
events_why_h2:'Why these evenings',
events_why_1_title:'Private setting',
events_why_1_text:'Maximum 12 guests aboard.',
...
event_form_guests_6_8:'6–8 guests',
event_form_guests_9_12:'9–12 guests',
...
event_ws_meta_guests:'12 guests max',
...
event_ws_narrative_p2:'A white dress code, twelve guests, one yacht. The whole evening built around the hour the sun goes down.',
event_ws_narrative_quote:'"This is the night we wait for all winter — the first time the season feels real." — Captain Alexei',
event_ws_narrative_promise:'Limited to twelve guests. We confirm reservations within two hours.',
...
events_page_sub:'Маленький сезон камерных вечеров на Адриатике — закаты, открытие сезона, ночные выходы. Только по брони, по двенадцать гостей.',
events_why_eyebrow:'Формат',
events_why_h2:'Почему именно эти вечера',
events_why_1_title:'Камерный формат',
events_why_1_text:'Не более 12 гостей на борту.',
...
event_form_guests_6_8:'6–8 гостей',
event_form_guests_9_12:'9–12 гостей',
...
event_ws_meta_guests:'до 12 гостей',
...
event_ws_narrative_p2:'Белый дресс-код, двенадцать гостей, одна яхта. Весь вечер выстроен вокруг часа заката.',
event_ws_narrative_quote:'«Это та ночь, которую ждёшь всю зиму — когда сезон впервые ощущается по-настоящему». — Капитан Алексей',
event_ws_narrative_promise:'Не более двенадцати гостей. Подтверждаем бронирования в течение двух часов.',
