...
blog_art3_excerpt:'Ничто не сравнится со вкусом свежей средиземноморской рыбы на гриле, когда солёный ветер обдувает лицо, а горы Боко-Которского залива служат фоном. Наш бортовой гриль — сердце каждого чартера, где сходятся отличная еда, смех и открытое море.',
...
const faqs = [
{q:{en:'What is included in the charter price?',ru:'Что включено в стоимость чартера?'},a:{en:'The charter price includes the yacht, captain, fuel for standard routes, bed linens, towels, snorkeling gear, and basic insurance. Food, drinks, port fees, and special requests are billed separately.',ru:'В стоимость входит яхта с капитаном и экипажем, топливо в пределах маршрута, страховка для всех пассажиров, SUP-доски, маски для снорклинга и подводный скутер, постельное бельё и полотенца. Еда, напитки и портовые сборы в Которе — отдельно, по факту, без наценки.'}},
{q:{en:'Do I need a boating license?',ru:'Нужна ли мне лицензия на управление судном?'},a:{en:'No license is required. Our yacht comes with a professional captain who knows every hidden bay and the best swimming spots along the coast.',ru:'Нет. На каждом чартере — наш капитан с 15-летним опытом на этих водах. Вам не нужны ни лицензия, ни опыт.'}},
{q:{en:'What is the cancellation policy?',ru:'Какова политика отмены?'},a:{en:'Free cancellation up to 14 days before departure. Cancellations within 14–7 days receive a 50% refund. Within 7 days, the booking is non-refundable. Rescheduling is always free if dates are available.',ru:'За 14+ дней до выхода — отмена бесплатная, полный возврат. За 14–7 дней — возврат 50%. Менее 7 дней — без возврата. Перенос на другие даты — всегда бесплатно, если они свободны.'}},
{q:{en:'Can we customize the itinerary?',ru:'Можно ли настроить маршрут?'},a:{en:'Absolutely. Every charter is tailored to your preferences. The captain will work with you to plan the perfect route based on weather, your interests, and the time of year.',ru:'Конечно — это и есть смысл частного чартера. Маршрут согласуем с вами за день до выхода с учётом погоды, ветра и того, что хотите увидеть. По ходу дня тоже корректируем — где задержаться, где плыть быстрее.'}},
{q:{en:'What is the best season for chartering?',ru:'Какое лучшее время для чартера?'},a:{en:'The Adriatic season runs from May to October. June and September offer the best balance of warm weather, calm seas, and fewer crowds. July and August are peak season.',ru:'Сезон — с мая по октябрь. Июнь и сентябрь — наш фаворит: тёплая вода, спокойный ветер, мало туристических катеров в заливе. Июль и август — пик, всё прекрасно, но на основных остановках многолюдно. В мае и октябре — самые приятные цены и пустые бухты.'}},
{q:{en:'How many guests can join?',ru:'Сколько гостей может быть на борту?'},a:{en:'Our yacht comfortably accommodates up to 16 guests for day charters. For weekly charters with overnight stays, the 4 cabins accommodate up to 8 guests.',ru:'До 16 гостей в дневном чартере, до 6 — с ночёвкой (4 каюты). Для больших компаний делаем дневной выход — обедаем на воде, плаваем и возвращаемся вечером.'}},
{q:{en:'Is there a bathroom and shower on board?',ru:'Есть ли туалет и душ на борту?'},a:{en:'Yes. There are 2 bathrooms with hot water showers on board. Fresh water is replenished every morning.',ru:'Да, на борту 2 санузла с душем и горячей водой. Пресная вода пополняется каждое утро.'}},
{q:{en:'Can we bring children?',ru:'Можно ли с детьми?'},a:{en:'Absolutely. We have child-sized life jackets, inflatable loungers and toys on board, and can arrange a kid-friendly menu. Just let us know the children\'s ages in advance.',ru:'Конечно. На борту детские спасжилеты, надувные шезлонги и игрушки, детское меню — по запросу. Скажите возраст детей при бронировании, чтобы мы подготовились.'}},
{q:{en:'Can we bring a dog?',ru:'Можно ли с собакой?'},a:{en:'Small and medium dogs are welcome — we have a designated area on the sundeck and freshwater bowls on board. Please mention your dog when booking so we can prepare.',ru:'Маленьких и средних собак берём — есть зона на солнечной палубе и миски с пресной водой. Скажите при бронировании, чтобы подготовиться.'}},
{q:{en:'Where do I park at Porto Montenegro?',ru:'Где парковаться в Порто Монтенегро?'},a:{en:'Porto Montenegro has paid covered parking right at the marina entrance — about €5 per day. We send the exact location pin via WhatsApp the day before your charter.',ru:'У марины есть крытая платная парковка прямо у входа — около €5 в сутки. Точную геолокацию пришлём в WhatsApp за день до выхода.'}},
{q:{en:'What if there is a storm on the day?',ru:'Что если в день чартера шторм?'},a:{en:'The captain decides. If the weather is unsafe, we reschedule for free to any available date — no cancellation fees, no questions asked. We watch the forecast 48 hours ahead and contact you if there is any risk.',ru:'Решение принимает капитан. Если погода небезопасна — переносим на любую свободную дату бесплатно, без штрафов. Прогноз смотрим за 48 часов и связываемся, если есть риск.'}}
];
const reviews = [
{
